...
# migrate/ dir
{{ project_name }}_opt_migrate:
    file.recurse:
        - source: salt://{{ base_app }}/source/opt/migrate
        - name: /opt/{{ project_name }}/migrate/
        - user: {{ admin_user }}
        - group: {{ admin_user }}
        - unless: ls /opt/{{ project_name }}/migrate
...
#
# core application (feincms config)
#
# create
{{ project_name }}_opt_core_application_create:
    cmd.run:
        ...
        - unless: ls /opt/{{ project_name }}/core

#
# init
#
# models
{{ project_name }}_opt_core_application_models:
    file.managed:
        - source: salt://{{ base_app }}/source/opt/core/models.py
        - name: /opt/{{ project_name }}/core/models.py
        - template: jinja
        - user: {{ admin_user }}
        - group: {{ admin_user }}

# utils
{{ project_name }}_opt_core_application_utils:
    file.managed:
        - source: salt://{{ base_app }}/source/opt/core/utils.py
        - name: /opt/{{ project_name }}/core/utils.py
        - template: jinja
        - user: {{ admin_user }}
        - group: {{ admin_user }}

# context_processors
{{ project_name }}_opt_core_application_context_processors:
    file.managed:
        - source: salt://{{ base_app }}/source/opt/core/context_processors.py
        - name: /opt/{{ project_name }}/core/context_processors.py
        - template: jinja
        - user: {{ admin_user }}
        - group: {{ admin_user }}
